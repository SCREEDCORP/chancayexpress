...
export default function Switcher() {
   ...
   useEffect(() => {
    ...
    return (
        <>
            <Link href="#" onClick={scrollToTop} id="back-to-top" className={`back-to-top  text-lg rounded-full z-10 bottom-5 end-5 h-9 w-9 text-center bg-violet-600 text-white leading-9  items-center flex justify-center ${scrollTop? "fixed": "hidden"}`}><FiArrowUp className='text-base'/></Link>
