                        ...
                        <div className="lg:col-span-3 md:col-span-4">
                            <div className="overflow-hidden rounded-md shadow dark:shadow-gray-800 sticky top-20">
                                ...
                                <div className="relative text-center -mt-10 p-6 pt-0">
                                    <Image src="/images/avatar/1.jpg" placeholder='blur' blurDataURL='/images/avatar/1.jpg' width={80} height={80} className="bg-white dark:bg-slate-900 h-20 w-20 rounded-full shadow-md dark:shadow-gray-800 mx-auto p-1" alt=""  />
