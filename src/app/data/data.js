export const ExploreItems = [
  {
    ...
    subtext: "Hamburguesa Clasica de la Casa",
    title: "Magnus Clasica",
    items: 25,
  ...
  },
  {
    id: 2,
    image: "/images/items/beef.jpg",
    title: "Cheese Carnivora",
    subtext: "Hamburguesa doble carne, doble queso.",
    items: 25,
    avatar: "/images/avatar/1.jpg",
    name: "Tiffany Betancourt",
    category: "Games",
    date: "January 22, 2024 1:0:1",
    subImages: [
      {
        index: 3,
  ...
  {
    id: 3,
    image: "/images/items/beef1.jpg",
    title: "Doble Rex",
    subtext: "Hamburguesa doble carne",
    items: 25,
  ...
  },
  {
    ...
    image: "/images/items/beef1.jpg",
    title: "La Porkus",
    subtext: "Doble carne, jamon y tocino ahumado",
    items: 25,
    avatar: "/images/avatar/5.jpg",
    name: "Mari Harrington",
    category: "Music",
    date: "March 01, 2024 1:6:6",
    subImages: [
      {
        index: 9,
  ...
  },
  {
    id: 5,
    image: "/images/items/beef1.jpg",
    title: "La Gallo Negro",
    subtext: "Hamburguesa mas pollo crujiente al limite",
    items: 25,
  ...
  },
  {
    ...
    image: "/images/items/beef.jpg",
    title: "La MR.BEEF",
    subtext: "Hamburguesa con doble tocino, huevo y jamon",
    items: 25,
    avatar: "/images/avatar/1.jpg",
    name: "Donna Schultz",
    category: "Games",
  ...
  },
  {
    ...
    image: "/images/items/beef1.jpg",
    title: "La Gaucha",
    subtext: "Hamburguesa mas chorizo a las finas hierbas y tocino",
    items: 25,
  ...
  },
  {
    id: 8,
    image: "/images/items/beef.jpg",
    title: "La Maximus Brutal",
    subtext: "Hamburguesa doble mas huevo,tocino,jamon,queso y platano",
    items: 15,
    avatar: "/images/items/3.gif",
    name: "Rosaria Vargas",
    category: "Art",
...
export const activityData = [
  {
    ...
    image: "/images/items/1.gif",
    title: "MR.BEEF",
    time: "1 HAMBURGUESA" /* cantidad del pedido*/,
    description: "Hamburguesa clasica de la casa ",
    amount: "Estado del pedido: pendiente, en cocina, listo ",
  },
  {
    id: 2,
    image: "/images/items/2.gif",
